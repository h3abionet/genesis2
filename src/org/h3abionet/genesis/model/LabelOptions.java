...
public class LabelOptions {
    ...
    public void modifyLabel(){
                ...
                Label cpLabel = new Label("Label color: ");
                TextField textField = new TextField(text.getText());
                ColorPicker cp = new ColorPicker((Color) text.getFill());
                cp.getStyleClass().add("split-button");
                
                ComboBox fontCombo = new ComboBox(FXCollections.observableArrayList(Font.getFamilies()));
                fontCombo.setValue(text.getFont().getFamily());
                ComboBox sizeCombo = new ComboBox(FXCollections.
