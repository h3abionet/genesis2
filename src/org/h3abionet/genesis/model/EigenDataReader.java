...
public class EigenDataReader {
     ...
     */
    public static float[][] createDataFromEigenInput(Fam fam, String inputFile) throws EigenDataException {
     ...
     */
    private static [][] extractDataFromEigenstratFile(Fam fam, String inputFile) {
        float pcs[][]=null; 
        try {
	    // get the first line of PCs and work out how many PCs there are
        } catch (IOException e) {
            e.printStackTrace();
        }
        pcs = new float [num_pcs] [num_inds_get_from_fam];
        try {
