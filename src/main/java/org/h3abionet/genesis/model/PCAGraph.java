                    ...
                    if (s.getName().equals(lab.getText())) {
                        lab.setOnMouseClicked(me -> {
                            ...
                            if (me.getButton() == MouseButton.PRIMARY) {
                                ...
                                try {
                                    FXMLLoader fxmlLoader = new FXMLLoader(Genesis.class.getClassLoader().getResource("view/PCAGroupLabel.fxml"));
...
//                    children.remove(children.size() - 1);
    ...
    public void showIndividualDetails(XYChart.Data<Number, Number> data, ScatterChart<Number, Number> chart) throws IOException {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(Genesis.class.getClassLoader().getResource("view/IndividualDetails.fxml"));
